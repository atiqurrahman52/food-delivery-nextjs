...
const Navbar = () => {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 w-full navbar backdrop-blur-[2px]">
          ...
          <nav className="container flex items-center justify-between py-1">
            ...
            <ul className="hidden md:flex items-center gap-6">
              ...
              <li id="cart-button" className="relative">
                <button onClick={() => setCart(!cart)} type="">
                  <svg
                    width="32"
                    height="32"
                    viewBox="0 0 32 32"
        ...
        <div className="w-full backdrop-blur-[2px] bg-[rgba(255,255,255,0.5)]">
          <nav className="px-4 py-2 md:py-0">
            <div className="flex justify-between">
              <div className="flex justify-center items-center">
                <Link href="/" className="md:hidden block w-8 h-8">
                  <img src="/assets/image/logo/logo.webp" alt="" />
                </Link>
              </div>
              ...
              <div className="flex gap-2.5 items-center">
                <div id="mob-cart-button" className="relative md:hidden block">
                  <button onClick={() => setMobileCart(!cart)}>
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                ...
                {cartMobile && (
                  <div
                    ...
                    className="flex justify-center items-center  absolute z-50 top-7 left-0 right-0 pt-10 mx-2"
                  >
                    <div className="relative bg-[#F9F6F1] w-[400px]  shadow-[0_24px_48px_-12px_rgba(0,0,0,0.18)] rounded-lg p-4 lg:p-6">
                      <p className="font-Playfair font-bold text-base lg:text-xl text-primary mb-4 pt-5">
                        Your Cart
                      </p>
                  ...
                  <div className="mobile-menu">
                    <ul className="flex flex-col justify-center items-center px-[34px]">
                      {navBarData.map(({ id, title, path }) => (
                        ...
                        >
                          <Link 
                          className={`${router.pathname === path ? 'activePage' :''}`}
                          href={path}>
                            {title}
                          </Link>
                        </li>
